...
common primary claim과 TERM `definition`은 2,000 codepoint다. canonical byte budget은 owner input 8 KiB, candidate와 전체 candidate batch envelope 각각 16 KiB, 실제 public output 32 KiB다. common tags/search_terms item은 최대 40자다.
