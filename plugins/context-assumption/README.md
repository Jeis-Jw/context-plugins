...
Version `0.7.1` keeps ASM as an optional semantic-owner package outside the `core-decision` installation profile. The `v0.7.1` tag and marketplace publication are still pending.
