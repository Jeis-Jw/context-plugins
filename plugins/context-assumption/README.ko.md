...
`0.8.0`에서 ASM은 `core-decision` 설치 profile 밖의 optional semantic-owner package이며 same-major core 호환성을 사용합니다. `v0.8.0` tag와 marketplace publication은 아직 완료되지 않았습니다.
