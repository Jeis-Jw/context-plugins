...
- The one-call snapshot change passes both complete suites: 379 passed, 646 subtests on Python 3.11 and 3.13, plus `compileall`.
- The list-body and skill-path fix passes both complete suites: 380 passed, 646 subtests on Python 3.11 and 3.13, plus `compileall`. The parent decision `integrity-write-boundary` was superseded by `ctx_292f1a32eeae4c0db02f4276ab7e0073` in the coordinating vault before this change landed.
