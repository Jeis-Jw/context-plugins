...
- Current repository version: `0.14.0`
- Release tag: `v0.14.0` (created and pushed by the owner; central marketplace publication is still a separate gate)
...
라이선스 선택과 `v0.14.0` tag 생성·push는 완료됐습니다. 중앙 marketplace publication과 directory 제출은 여전히 별도 owner gate이며, tag push만으로 완료됐다고 간주하지 않습니다.
